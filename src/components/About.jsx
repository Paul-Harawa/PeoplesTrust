        ...
        <div className='flex flex-col text-center py-5'>
            ...
            <div className='pt-6 flex md:flex-row flex-col p-2 justify-around md:space-y-0 space-y-2'>
                ...
                <p className='p-4 text-justify font-light text-md w-full bg-black bg-opacity-5 rounded-2xl'>
                    <b className='font-extrabold'><span className='text-[#cf6969]'>Peoples</span> <span className='text-[#5285eb]'>Welfare Trust</span> </b> is non-profitable organization dedicated to building a nation where the general welfare of the elderly, orphaned and vulnerable children is promoted for them to live holistic and fulfilling life while they are in their ancestral land.  We provide advocacy, expert advice, conduct outreach and implement strategic developmental and supporting programs focused on Elderly, Orphaned and vulnerable children. <br /><br />
                    The Peoples Welfare Trust established in 2025 to fill a critical gap regarding civil society participation in improving living conditions of elderly, orphans and vulnerable children in Malawi. Determined to drive change, support and care orphans and vulnerable children while they are in their ancestral land and empower the elders to thrive as valued members of their communities. The organization is also worked on influencing policy, empower general communities and champion sustainable development, contributing a more resilient Malawi. <br /><br />
  
                    <b>In 2025 Peoples Welfare Trust was registered as non-profit organization under Trustees Incorporation Act with both board of Trustees and executive board members.  </b>
            ...
            <div className='pt-6 flex md:flex-row flex-col p-2 justify-around md:space-y-0 space-y-2'>
                ...
                <div className='md:w-1/4 h-auto'>
                        <img src={new URL('/src/assets/images/logo1.png', import.meta.url).href} alt="" className=' border border-gray-50 border-x-[#FF9292] rounded-full ' />
                </div>
            </div>
